...
$quer="SELECT CourseCode,CourseName FROM CourseTable WHERE Department='$cat'"; 
}else{$quer="SELECT CourseCode,CourseName FROM CourseTable WHERE Year='1'"; } 
...
echo "    <option value='Mechnical'>Mechnical</option>";
       echo"   <option value='Electrical'>Electrical</option>";
          
           
        echo"  <option value='SectionC'>SectionC</option>"; 
