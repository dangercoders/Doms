 ...
 */
	...
	$from="dangercoders@gmail.com";                           /* Change this to your address like "me@mydomain.com"; */ 
	...
	$smtp->user="dangercoders@gmail.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="Shubh@m001";                 /* Set to the authetication password */
